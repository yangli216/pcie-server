...
全医慧助（PCIE，Primary Care Intelligent Expert）服务端工程 `pcie-server` 的协作规则。

本项目是全医慧助桌面端 `pcie` 的配套后台，当前采用：
...
5. 涉及桌面端真实调用时，补读 [../development-harness/HARNESS.md](../development-harness/HARNESS.md)、[../pcie/HARNESS.md](../pcie/HARNESS.md) 和：
