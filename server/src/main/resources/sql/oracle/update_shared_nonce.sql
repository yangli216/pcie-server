-- Oracle 19c shared nonce schema for an explicitly enabled multi-node deployment.
-- DBA-reviewed manual execution only. This script creates no users and changes no connections.
